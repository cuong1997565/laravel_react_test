    ...
    getApiPost() {
        ...
        axios.get(`/api/posts/${postId}`).then((response) => {
           this.setState({
               ...
               image_show : response.data.post.images,
               status: response.data.post.status === 1 ? true : false,
            ...
            <div className='container py-4'>
                <div className='row justify-content-center'>
                    <div className='col-md-12'>
                        <div className='card'>
                            <div className='card-header'>Edit new post</div>
                            <div className='card-body'>
                                <form onSubmit={this.handleSubmit} encType="multipart/form-data" >
                                    ...
                                    <div className="form-group">
                                        ...
                                        />
                                        <img id="output" src={`/storage/images/${this.state.image_show}`} width="100px" height="100px" className="image-reposite-add" />
